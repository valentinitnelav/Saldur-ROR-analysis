---
title: "BACI analysis for density (individuals/m2)"
...
models[[1]] <- glmmTMB(ind_m2 ~ period_ba * treatment_ci + (1|site_f) + (1|year_f), 
                       data = baci_dt, family = Gamma(link = "log"))

# Model with interaction in the random effects structure
models[[2]] <- glmmTMB(ind_m2 ~ period_ba * treatment_ci + (1|site_f) + (1|year_f) + (1|site_f:year_f), 
                       data = baci_dt, family = Gamma(link = "log"))
```
...
model.no.interaction <- glmmTMB(ind_m2 ~ period_ba + treatment_ci + (1|site_f) + (1|year_f), 
                                data = baci_dt, family = Gamma(link = "log"))
