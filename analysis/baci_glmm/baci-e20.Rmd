...
The AIC test favors that the more complex model (with `site_f:year_f`) but the less complex one has substantial empirical support. The LRT test indicates that there are no significant differences between the two models. According to the rule of parsimony, we pick the simpler model for further analysis.
